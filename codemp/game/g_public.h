...
typedef struct gameImport_s {
	...
	void 		(*Phys_Obj_Set_Linear_Velocity)			( phys_object_t*, float* lin );
	void 		(*Phys_Obj_Get_Linear_Velocity)			( phys_object_t*, float* lin );
	void		(*Phys_Obj_Set_Angular_Velocity)		( phys_object_t* obj, float* ang );
	void		(*Phys_Obj_Get_Angular_Velocity)		( phys_object_t* obj, float* ang );
