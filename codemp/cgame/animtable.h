...
stringID_table_t vmAnimTable[MAX_VIEWMODEL_ANIMATIONS + 1] = 
{
	...
	ENUM2STRING(VM_ARMS_READY),
	ENUM2STRING(VM_ARMS_IDLE),
	ENUM2STRING(VM_ARMS_IDLE_SEQ),
	ENUM2STRING(VM_ARMS_RAISE),
	ENUM2STRING(VM_ARMS_LOWER),
	ENUM2STRING(VM_ARMS_FIRE),
	ENUM2STRING(VM_ARMS_ALT_FIRE),
	ENUM2STRING(VM_ARMS_THERMAL_PULLBACK),
	ENUM2STRING(VM_ARMS_FPUSH),
	ENUM2STRING(VM_ARMS_FPULL),
