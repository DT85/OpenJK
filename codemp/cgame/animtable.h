...
stringID_table_t vmAnimTable[MAX_VIEWMODEL_ANIMATIONS + 1] = 
{
	...
	ENUM2STRING(VM_IDLE),
	ENUM2STRING(VM_IDLE_SEQ),
	ENUM2STRING(VM_RAISE),
	ENUM2STRING(VM_LOWER),
	ENUM2STRING(VM_FIRE),
	ENUM2STRING(VM_ALT_FIRE),
	/*ENUM2STRING(VM_LH_FIRE),
	ENUM2STRING(VM_RH_FIRE),
	ENUM2STRING(VM_RELOAD),*/
	ENUM2STRING(VM_THERMAL_PULLBACK),
	//ENUM2STRING(VM_WEAPON_MELEE),
	ENUM2STRING(VM_FPUSH),
	ENUM2STRING(VM_FPULL),

	ENUM2STRING(VM_REPEAT_READY),
	ENUM2STRING(VM_REPEAT_IDLE),
	ENUM2STRING(VM_REPEAT_IDLE_SEQ),
	ENUM2STRING(VM_REPEAT_RAISE),
	ENUM2STRING(VM_REPEAT_LOWER),
	ENUM2STRING(VM_REPEAT_FIRE),
	ENUM2STRING(VM_REPEAT_ALT_FIRE),
	/*ENUM2STRING(VM_REPEAT_RELOAD),
	ENUM2STRING(VM_REPEAT_MELEE),*/

	ENUM2STRING(VM_DISRUPT_READY),
	ENUM2STRING(VM_DISRUPT_IDLE),
	ENUM2STRING(VM_DISRUPT_IDLE_SEQ),
	ENUM2STRING(VM_DISRUPT_RAISE),
	ENUM2STRING(VM_DISRUPT_LOWER),
	ENUM2STRING(VM_DISRUPT_FIRE),
	ENUM2STRING(VM_DISRUPT_ALT_FIRE),
	/*ENUM2STRING(VM_DISRUPT_RELOAD),
	ENUM2STRING(VM_DISRUPT_MELEE),
	ENUM2STRING(VM_DISRUPT_CHARGE),*/
